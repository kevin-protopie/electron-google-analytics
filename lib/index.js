  ...
  _createClass(Analytics, [{
    ...
    value: function send(hitType, params, clientID) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var url = "".concat(_this.globalBaseURL).concat(_this.globalCollectURL);

        if (_this.globalDebug) {
          url = "".concat(_this.globalBaseURL).concat(_this.globalDebugURL).concat(_this.globalCollectURL);
        }
        ...
        if (_this.globalUserAgent !== '') {
          reqObj.headers = {
            'User-Agent': _this.globalUserAgent
          };
        }

        return _request["default"].post(reqObj, function (err, httpResponse, body) {
